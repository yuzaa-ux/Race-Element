...
internal sealed class Nordschleife : AbstractTrackData
{
    ...
    {
        { new FloatRangeStruct(0.0169f, 0.025f), (1, "Haug-Haken")},
        { new FloatRangeStruct(0.025f, 0.03f), (2, "")},
        { new FloatRangeStruct(0.041f, 0.0487f), (3, "Valvoline-Kurve")},
        { new FloatRangeStruct(0.0488f, 0.0575f), (4, "Ford-Kurve")},
        { new FloatRangeStruct(0.0697f, 0.081f), (5, "Dunlop-Kehre")},
        { new FloatRangeStruct(0.0867f, 0.0935f), (6, "Michael-Schumacher-S")},
        { new FloatRangeStruct(0.0936f, 0.1006f), (7, "Michael-Schumacher-S")},
        { new FloatRangeStruct(0.1091f, 0.116f), (8, "Michelin-Kurve")},
        { new FloatRangeStruct(0.1186f, 0.1274f), (9, "Warsteiner-Kurve")},
        { new FloatRangeStruct(0.1345f, 0.1445f), (10, "ADVAN-Bogen")},
        { new FloatRangeStruct(0.1525f, 0.1585f), (11, "NGK-Schikane")},
        { new FloatRangeStruct(0.1586f, 0.1639f), (12, "NGK-Schikane")},
        { new FloatRangeStruct(0.166f, 0.172f), (13, "Kurzanbindung")},
        ...
        { new FloatRangeStruct(0.3654f, 0.3807f), (25, "Adenauer Forst")},
        { new FloatRangeStruct(0.3921f, 0.3981f), (26, "Rebel Tree")},
        ...
        { new FloatRangeStruct(06197f, 0.6316f), (39, "Steilstrecke")},
        { new FloatRangeStruct(0.6394f, 0.6479f), (40, "Caracciola Karussell")},
        { new FloatRangeStruct(0.6799f, 0.6858f), (41, "Hohe Acht")},
        ...
        { new FloatRangeStruct(0.8725f, 0.9598f), (53, "Döttinger Höhe")},
        { new FloatRangeStruct(0.95985f, 0.9741f), (54, "Tiergarten")},
        { new FloatRangeStruct(0.9753f, 0.985f), (55, "Hohenrain-Schikane")}
    };
